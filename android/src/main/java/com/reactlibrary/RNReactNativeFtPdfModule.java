...
public class RNReactNativeFtPdfModule extends ReactContextBaseJavaModule {

  private  ReactApplicationContext reactContext;

  public RNReactNativeFtPdfModule(ReactApplicationContext reactContext) {
    super(reactContext);
  ...
  public void getIntFromReactNative(Integer i) {
    Toast.makeText(reactContext, "" + i, Toast.LENGTH_SHORT).show();
  }
  ...
  public void getDictionaryFromRN(ReadableMap map) {
    ...
    Toast.makeText(reactContext, "已收到字典数据", Toast.LENGTH_SHORT).show();
  }
  ...
  public void getArrayFromRN(ReadableArray array) {
    ...
    Toast.makeText(reactContext, "已收到数组数据", Toast.LENGTH_SHORT).show();
  }
